...
export default function ProjectFiltersSidebar({
  categories,
  selectedCategory,
  setSelectedCategory,
}: any) {
  return (
    <motion.div
      ...
      className="col-span-12 md:col-span-3 flex flex-col gap-6 p-4 rounded-lg bg-white dark:bg-black h-fit border-t -ml-12 mr-0 md:mr-4 sticky top-16"
    >
      <div>
